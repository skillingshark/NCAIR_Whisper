...
// After the build this file would be converted to wasm binary file to be used within javascript 
// This file on it is not required after the build for the model to process
